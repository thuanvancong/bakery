...
function botiga_scripts() {
	...
	wp_enqueue_style( 'sub-style', get_template_directory_uri() . '/assets/css/sub-style.css', array(), BOTIGA_VERSION );
	wp_enqueue_style( 'sub-style', get_template_directory_uri() . '/assets/css/baguetteBox.min.css', array(), BOTIGA_VERSION );
	wp_enqueue_style( 'bootstrap.min', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), BOTIGA_VERSION );
	wp_enqueue_style( 'font', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array(), BOTIGA_VERSION );
	wp_enqueue_style( 'responsive', get_template_directory_uri() . '/assets/css/responsive.css', array(), BOTIGA_VERSION );
	wp_enqueue_style( 'animate', get_template_directory_uri() . '/assets/css/animate.css', array(), BOTIGA_VERSION );
	wp_enqueue_style( 'custom', get_template_directory_uri() . '/assets/css/custom.css', array(), BOTIGA_VERSION );
	...
	// Register files js.
	wp_register_script( 'mapify', get_template_directory_uri() . '/assets/js/extentions/jquery.mapify.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'images-loded', get_template_directory_uri() . '/assets/js/extentions/images-loded.min.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'bootstrap', get_template_directory_uri() . '/assets/js/extentions/bootstrap.min.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'legacy', get_template_directory_uri() . '/assets/js/extentions/legacy.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'baguetteBox', get_template_directory_uri() . '/assets/js/extentions/baguetteBox.min.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'custom', get_template_directory_uri() . '/assets/js/extentions/custom.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'picker', get_template_directory_uri() . '/assets/js/extentions/picker.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'picker.date', get_template_directory_uri() . '/assets/js/extentions/picker.date.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'picker.time', get_template_directory_uri() . '/assets/js/extentions/picker.time.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'isotope.min', get_template_directory_uri() . '/assets/js/extentions/isotope.min.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'form-validator.min', get_template_directory_uri() . '/assets/js/extentions/form-validator.min.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'contact-form-script.js', get_template_directory_uri() . '/assets/js/extentions/contact-form-script.js', null, BOTIGA_VERSION, true );
	wp_register_script( 'popper', get_template_directory_uri() . '/assets/js/extentions/popper.min.js', null, BOTIGA_VERSION, true );
	...
	wp_enqueue_script( 'popper', get_template_directory_uri() . '/assets/js/extentions/popper.min.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/extentions/bootstrap.min.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'swiper-bundle', get_template_directory_uri() . '/assets/js/extentions/images-loded.min.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'images-loded', get_template_directory_uri() . '/assets/js/extentions/images-loded.min.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'isotope.min', get_template_directory_uri() . '/assets/js/extentions/isotope.min.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'baguetteBox', get_template_directory_uri() . '/assets/js/extentions/baguetteBox.min.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'mapify', get_template_directory_uri() . '/assets/js/extentions/jquery.mapify.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'legacy', get_template_directory_uri() . '/assets/js/extentions/legacy.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'picker', get_template_directory_uri() . '/assets/js/extentions/picker.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'picker.date', get_template_directory_uri() . '/assets/js/extentions/picker.date.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'picker.time', get_template_directory_uri() . '/assets/js/extentions/picker.time.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'form-validator.min', get_template_directory_uri() . '/assets/js/extentions/form-validator.min.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'contact-form-script.js', get_template_directory_uri() . '/assets/js/extentions/contact-form-script.js', array(), BOTIGA_VERSION, true );
	wp_enqueue_script( 'custom', get_template_directory_uri() . '/assets/js/extentions/custom.js', array(), BOTIGA_VERSION, true );
